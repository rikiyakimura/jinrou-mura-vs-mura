...
const ITEMS = {
  permit: {
    ...
    description: '護衛に夜味方1人を守らせる許可証。ただし護衛自身と人狼は守れない。護衛が探索に出た夜は使えない。味方の護衛が生存していないと無効となる。取得した日にのみ有効。'
  },
  mad: {
    id: 'mad',
    name: '狂人の爪',
    image: '/item/kyoujinnotume.webp',
    description: '狂人に爪を研がせて贋の音を鳴らす。相手の探索者に向けて人狼の居場所を撹乱できるが、相手の探索者が犬飼いの場合偽物と見破られる。狂人が探索に出ると使えない。味方の狂人が生存していないと無効となる。取得した日にのみ有効。'
  },
  medium: {
    id: 'medium',
    name: '霊媒の札',
    image: '/item/reibainohuda.webp',
    description: '相手の村人を襲撃した翌日、襲撃に成功した時のみ襲撃した相手村人の役職が分かる。霊媒師が探索に出た夜は札が働かない。味方の霊媒師が生存していないと無効となる。取得した日にのみ有効。'
  }
};
